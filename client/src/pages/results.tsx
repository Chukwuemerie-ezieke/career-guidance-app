  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="hidden print:block text-center py-6 border-b">
        <h1 className="text-xl font-bold">The Incubators Secondary Academy Ufuma</h1>
        <h2 className="text-lg">Career Guidance Report</h2>
      ...
      <div className="hidden print:block text-center py-4 border-t text-xs">
        ...
        <p className="mt-0.5">The Incubators Secondary Academy Ufuma — Career Guidance Report</p>
      </div>
